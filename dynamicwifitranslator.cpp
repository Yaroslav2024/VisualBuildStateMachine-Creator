...
DynamicResult DynamicWifiTranslator::generate(QGraphicsScene *scene, const QString &manualHeader, const QString &ssid, const QString &pass)
{
    ...
    // ==========================================
        ...
        out << "void StateMachine::setup() {\n";
                ...
                out << "    server->begin();\n";
                out << "    Serial.println(\"\\n[Wi-Fi] Connected!\");\n";
                out << "    Serial.print(\"[Wi-Fi] IP Address: \");\n";
                out << "    Serial.println(WiFi.localIP());\n";
                out << "    \n";
                out << "    // НОВОЕ: АВТОНОМНЫЙ СТАРТ БЕЗ БЛОКИРОВКИ!\n";
                out << "    Serial.println(\"Autonomous start in 2 seconds...\");\n";
                out << "    delay(2000);\n";
                out << "    FSM_Init();\n";
                out << "}\n\n";
