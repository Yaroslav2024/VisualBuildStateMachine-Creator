...
DynamicMicroTranslator::DynamicMicroTranslator(QObject *parent) : QObject(parent) {}

DynamicResult DynamicMicroTranslator::generate(QGraphicsScene *scene, const QString &manualHeader)
{
    ...
    // ==========================================
        ...
        out << "// --- DYNAMIC DEBUG FIRMWARE (USB Serial - Class Mode) ---\n";
        ...
        out << "    // We are waiting endlessly for the cable to be connected/the port to open.\n";
        out << "    while(!Serial) { delay(10); } // Wait for USB connection\n";
        out << "    delay(500);\n";
        ...
        out << "    if (Serial.availableForWrite() >= 16) {\n";
        out << "        Serial.print(\"[\"); Serial.print(type); Serial.print(\":\");\n";
        out << "        Serial.print(id); Serial.println(\"]\");\n";
        out << "    }\n";
        out << "}\n\n";
        ...
        for (const auto& block : blocks) {
            ...
            if (BridgeItem* bridge = dynamic_cast<BridgeItem*>(block.item)) {
                ...
                if (targetId != -1) {
                    ...
                    out << "    Serial.println(\"Error: Bridge target not found!\");\n";
...
// === Утилиты ===
QString DynamicMicroTranslator::sanitizeForArduino(const QString &rawCode, bool isCondition) {
...
QString DynamicMicroTranslator::extractVariables(const QString &rawCode, QMap<QString, VariableInfo> &vars) {
